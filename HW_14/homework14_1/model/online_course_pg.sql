...
create index on instructors (created_at desc);
...
create unique index on courses (name);
...
create index on students (created_at desc);
...
alter sequence instructors_id_seq restart with 32;
...
alter sequence courses_id_seq restart with 28;
